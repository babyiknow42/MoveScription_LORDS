...
export async function executeTransaction(sKey: string,seconds: number = 10, tick: string = "LORDS") {
  const secretKey = sKey; // 修改这里，填入私钥
  const PACKAGE_ID =
    "0xebbba763f5fc01d90c2791c03536a373791b634600e81d4e08b85f275f1274fa"; // mainnet
  const TickRecordID =
    "0xa09c5763a68f91cbcd586ed4b65050085b5152764cb67550385f58dfca9c9eae"; // mainnet
